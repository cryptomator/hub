...
async function updateVaultMetadata() {
  ...
  try {
    ...
    const updatedVault = await backend.vaults.createOrUpdateVault(vault.id, vaultName.value, vault.archived, vault.requiredEmergencyKeyShares, vault.emergencyKeyShares, vaultDescription.value);
