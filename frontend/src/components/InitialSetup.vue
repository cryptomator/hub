<template>
  ...
  <div v-if="state == State.Preparing" class="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
  ...
  <div v-else-if="me != null && state == State.CreateUserKey" class="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
  ...
  <div v-else-if="me != null && state == State.EnterSetupCode" class="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
