...
This chart contains a OCI chart signature, which can be verified as follows (assuming chart version `2.1.1`):
...
cosign verify \
  ...
  ghcr.io/cryptomator/charts/cryptomator-hub:2.1.1
```
