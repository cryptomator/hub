...
This chart contains a OCI chart signature, which can be verified as follows (assuming chart version `2.1.0`):
...
cosign verify \
  ...
  ghcr.io/cryptomator/charts/cryptomator-hub:2.1.0
```
