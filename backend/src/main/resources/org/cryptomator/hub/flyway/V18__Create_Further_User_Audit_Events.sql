...
(
	"id"         BIGINT NOT NULL,
	"changed_by" VARCHAR(255) COLLATE "C" NOT NULL,
	CONSTRAINT "AUDIT_EVENT_USER_SETUPCODE_CHANGED_PK" PRIMARY KEY ("id"),
	CONSTRAINT "AUDIT_EVENT_USER_ACCOUNT_SETUPCODE_CHANGED_EVENT" FOREIGN KEY ("id") REFERENCES "audit_event" ("id") ON DELETE CASCADE
);