...
(
    ...
    CONSTRAINT "FK_GROUP_USER_ON_GROUP" FOREIGN KEY ("group_id") REFERENCES "group" ("id") ON DELETE CASCADE,
...
(
    ...
    CONSTRAINT "FK_VAULT_GROUP_ON_GROUP" FOREIGN KEY ("group_id") REFERENCES "group" ("id") ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT "FK_ACCESS_ON_USER" FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE,
