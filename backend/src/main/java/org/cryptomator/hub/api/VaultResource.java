...
public class VaultResource {
	...
	public List<AuthorityDto> getMembers(@PathParam("vaultId") @ValidUUID String vaultId) {
	...
	@ActiveLicense
	public Response addUser(@PathParam("vaultId") @ValidUUID String vaultId, @PathParam("userId") @ValidId String userId) {
		var vault = Vault.<Vault>findByIdOptional(vaultId).orElseThrow(NotFoundException::new);
	...
	@ActiveLicense
	public Response addGroup(@PathParam("vaultId") @ValidUUID String vaultId, @PathParam("groupId") @ValidId String groupId) {
	...
	@APIResponse(responseCode = "403", description = "VaultAdminAuthorizationJWT expired or not yet valid")
	@APIResponse(responseCode = "404", description = "vault not found")
	public Response removeMember(@PathParam("vaultId") @ValidUUID String vaultId, @PathParam("userId") @ValidId String userId) {
	...
	@APIResponse(responseCode = "403", description = "VaultAdminAuthorizationJWT expired or not yet valid")
	@APIResponse(responseCode = "404", description = "vault not found")
	public Response removeGroup(@PathParam("vaultId") @ValidUUID String vaultId, @PathParam("groupId") @ValidId String groupId) {
	...
	@APIResponse(responseCode = "403", description = "VaultAdminAuthorizationJWT expired or not yet valid")
	@APIResponse(responseCode = "404", description = "vault not found")
	public List<DeviceResource.DeviceDto> getDevicesRequiringAccessGrant(@PathParam("vaultId") @ValidUUID String vaultId) {
	...
	@ActiveLicense
	public String unlock(@PathParam("vaultId") @ValidUUID String vaultId, @PathParam("deviceId") @ValidUUID String deviceId) {
		var usedSeats = EffectiveVaultAccess.countEffectiveVaultUsers();
		if (usedSeats > license.getAvailableSeats()) {
	...
	public Response grantAccess(@PathParam("vaultId") @ValidUUID String vaultId, @PathParam("deviceId") @ValidUUID String deviceId, @ValidJWE String jwe) {
		var vault = Vault.<Vault>findByIdOptional(vaultId).orElseThrow(NotFoundException::new);
	...
	public VaultDto get(@PathParam("vaultId") @ValidUUID String vaultId) {
	...
	public Response create(@PathParam("vaultId") @ValidUUID String vaultId, @Valid VaultDto vaultDto) {
		if (vaultDto == null) {
