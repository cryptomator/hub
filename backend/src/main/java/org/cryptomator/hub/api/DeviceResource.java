...
public class DeviceResource {
	...
	public Response create(@Valid DeviceDto deviceDto, @PathParam("deviceId") @Pattern(regexp = ValidationPatterns.ID_PATTERN) String deviceId) {
	...
	public Response remove(@PathParam("deviceId") @Pattern(regexp = ValidationPatterns.ID_PATTERN) String deviceId) {
	...
	public record DeviceDto(@JsonProperty("id") @Pattern(regexp = ValidationPatterns.ID_PATTERN) String id,
