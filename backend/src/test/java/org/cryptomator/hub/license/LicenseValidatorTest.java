...
class LicenseValidatorTest {
	...
	private static final String VALID_TOKEN = "..AZrb7lULe-bvea6LyFsTq7dZZBozgXuqEnr8M5nua-3KyM6gZw_hygBVkmAZw-u4NMlG8u0GEpKlK9rmLUPOpF36AaTa3h9WCQIzmiqn30Rm_zRd9T3WrmWXjkmWKnv7YpfufZI_zT-lpcKGasGm1w3YVWu_nSa9gQd_0Pm1r3QSQWTX";
	...
	void testValidateValidLegacyToken() {
	...
	void testValidateValidToken() {
		var verifierProducer = new LicenseVerifierProducer("Hub License Issuer CA (Test)");
		var validator = new LicenseValidator(verifierProducer.produceLicenseVerifier()); // uses the built-in production root certificate
		...
		Assertions.assertEquals("42", jwt.getId());
		Assertions.assertEquals("Cryptomator Hub", jwt.getAudience().get(0));
		Assertions.assertEquals("hub@example.com", jwt.getSubject());
		Assertions.assertEquals(5, jwt.getClaim("seats").asInt());
		Assertions.assertEquals(32503680000L, jwt.getExpiresAt().getTime() / 1000);
		Assertions.assertEquals(HubLicenseEntitlements.create().withSeats(5), jwt.getClaim("org.cryptomator.hub.entitlements").as(HubLicenseEntitlements.class));
	}
