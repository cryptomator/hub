...
public class ValidationPatternsTest {
	...
	public void testIdPatternValid(String matches) {
		var result = Pattern.matches(ValidationPatterns.ID_PATTERN, matches);
	...
	public void testIdPatternInvalid(String fails) {
		var result = Pattern.matches(ValidationPatterns.ID_PATTERN, fails);
	...
	public void testNamePatternValid(String matches) {
		var result = Pattern.matches(ValidationPatterns.NAME_PATTERN, matches);
		Assertions.assertTrue(result);
	}
	...
	public void testNamePatternInvalid(String fails) {
		var result = Pattern.matches(ValidationPatterns.NAME_PATTERN, fails);
		Assertions.assertFalse(result);
	}
}
